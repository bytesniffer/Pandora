 ...
 * @Last Modified time: 2021-03-26 12:41:40
 */
...
class ContentService extends Service {
  async find(
    ...
    const listdata = _list(this, this.ctx.model.Content, payload, {
      attributes,
      query,
      searchKeys: ['stitle', 'title', 'comments', 'discription'].concat(
        searchKeys
      ),
      searchParams,
  ...
  async updateByCondition(id, payload, query) {
      return _update(this, this.ctx.model.Content, id, payload, query);
    }
