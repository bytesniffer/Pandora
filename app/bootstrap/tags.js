 ...
 * @Last Modified time: 2021-07-04 13:23:48
 */
...
=======
  ...
  this.run = function (context, args, bodyCallback) {
    ...
    // 默认插件支持
    metaArr.push(
      `<script type="text/javascript" src="${_ctx.staticRootPath}/plugins/avalon.js/2.2.7/avalon.min.js?version=${_ctx.site.version}"></script>`
    );
    metaArr.push(
      `<script type="text/javascript" src="${_ctx.staticRootPath}/plugins/jquery/1.10.2/jquery.min.js?version=${_ctx.site.version}"></script>`
    );
    metaArr.push(
      `<script type="text/javascript" src="${_ctx.staticRootPath}/plugins/layer/layer.js?version=${_ctx.site.version}"></script>`
    );
    metaArr.push(
      `<script type="text/javascript" src="${_ctx.staticRootPath}/themes/users/js/dora.front.js?version=${_ctx.site.version}"></script>\n`
    );
    metaArr.push(
      `<link rel="stylesheet" href="${_ctx.staticRootPath}/plugins/layer/theme/default/layer.css">`
    );

    if (params.adaptor === 'modernizr') {
      metaArr.push(
...
>>>>>>> 2.1.8-dev
    ...
    if (_ctx.site.router === 'users') {
      ...
      metaArr.push(
        `<script type="text/javascript" src="${_ctx.staticRootPath}/themes/users/js/avalon-ms-pager.js?version=${_ctx.site.version}"></script>\n`
      );
    }
...
global.AssetsExtension = function () {
  ...
  this.run = function (context, args, bodyCallback) {
    ...
    for (const item of assetsKeyArr) {
      ...
      if (fileExtension === 'js') {
        assetsStr += `<script type="text/javascript" src="${targetPath}?version=${_ctx.site.version}"></script>\n`;
